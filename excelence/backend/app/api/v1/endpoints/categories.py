...
def create_category(category: CategoryCreate, user: dict = Depends(deps.get_current_user)):
    """
...
def read_categories(user: dict = Depends(deps.get_current_user)):
    """
...
def update_category(category_id: int, category: CategoryUpdate, user: dict = Depends(deps.get_current_user)):
    """
...
def delete_category(category_id: int, user: dict = Depends(deps.get_current_user)):
    """
    ...
    try:
        ...
        transaction_check = supabase.table('transactions').select('id', count='exact').eq('category_id', category_id).eq('user_id', user_id).execute()
